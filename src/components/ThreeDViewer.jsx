...
function RoomContents({ room, cx, cz, rw, rd }) {
  ...
  if (t === "living")
    return (
      <group>
        ...
        {/* Coffee table */}
        <Box
          pos={[cx, 0.2, cz + rd * 0.04]}
          size={[rw * 0.28, 0.4, rd * 0.15]}
          color="#6b4c2a"
          roughness={0.55}
        />
        {/* TV console */}
        <Box
          pos={[cx, 0.2, cz - rd * 0.32]}
          size={[rw * 0.48, 0.4, rd * 0.1]}
          color="#3c3020"
          roughness={0.6}
        />
        {/* TV screen */}
        <Box
          pos={[cx, 0.75, cz - rd * 0.33]}
          size={[rw * 0.42, 0.5, 0.04]}
          color="#101010"
          roughness={0.05}
          metalness={0.2}
        />
  ...
  if (t === "bedroom")
    return (
      <group>
        <Bed
          pos={[cx - rw * 0.08, 0, cz + rd * 0.08]}
          size={[rw * 0.55, 0.5, rd * 0.58]}
        />
        {/* Nightstand */}
        <Box
          pos={[cx + rw * 0.32, 0.2, cz + rd * 0.08]}
          size={[rw * 0.12, 0.4, rd * 0.12]}
          color="#7a5c3a"
        />
        {/* Wardrobe */}
        <Box
          pos={[cx - rw * 0.34, 1.0, cz - rd * 0.38]}
          size={[rw * 0.28, 2.0, rd * 0.14]}
          color="#8a6040"
          roughness={0.6}
        />
        {/* Desk/dresser */}
        <Box
          pos={[cx + rw * 0.3, 0.4, cz - rd * 0.38]}
          size={[rw * 0.3, 0.8, rd * 0.14]}
          color="#7a5c3a"
        />
  ...
  if (t === "kitchen")
    return (
      <group>
        ...
        <Box
          pos={[cx, 0.45, cz - rd * 0.4]}
          size={[rw * 0.8, 0.9, rd * 0.14]}
          color="#d0c8b8"
          roughness={0.4}
        />
        {/* Upper cabinets */}
        <Box
          pos={[cx, 1.8, cz - rd * 0.42]}
          size={[rw * 0.7, 0.7, rd * 0.1]}
          color="#c8c0b0"
          roughness={0.5}
        />
        {/* Island */}
        <Box
          pos={[cx, 0.45, cz + rd * 0.1]}
          size={[rw * 0.38, 0.9, rd * 0.22]}
          color="#d8d0c0"
          roughness={0.4}
        />
        {/* Sink area */}
        <Box
          pos={[cx, 0.88, cz - rd * 0.4]}
          size={[rw * 0.2, 0.06, rd * 0.14]}
          color="#8899aa"
          roughness={0.2}
          metalness={0.5}
        />
  ...
  if (t === "bathroom")
    return (
      <group>
        {/* Bathtub */}
        <Box
          pos={[cx - rw * 0.18, 0.22, cz + rd * 0.18]}
          size={[rw * 0.38, 0.44, rd * 0.45]}
          color="#e0eef8"
          roughness={0.15}
          metalness={0.05}
        />
        {/* Inside of tub */}
        <Box
          pos={[cx - rw * 0.18, 0.32, cz + rd * 0.18]}
          size={[rw * 0.3, 0.2, rd * 0.36]}
          color="#c8e0f0"
          roughness={0.1}
        />
        {/* Vanity */}
        <Box
          pos={[cx + rw * 0.2, 0.44, cz - rd * 0.35]}
          size={[rw * 0.35, 0.88, rd * 0.16]}
          color="#d8d0c4"
          roughness={0.5}
        />
        {/* Mirror */}
        <Box
          pos={[cx + rw * 0.2, 1.3, cz - rd * 0.43]}
          size={[rw * 0.28, 0.6, 0.03]}
          color="#c0d8e8"
          roughness={0.05}
          metalness={0.3}
          opacity={0.7}
        ...
        {/* Toilet */}
        <Box
          pos={[cx - rw * 0.2, 0.2, cz - rd * 0.35]}
          size={[rw * 0.18, 0.4, rd * 0.2]}
          color="#eef4f8"
          roughness={0.2}
        />
      </group>
        ...
        {t === "dining" && (
          <>
            ...
            {[
              ...
              <Box
                key={i}
                pos={[cx + offset[0], 0.22, cz + offset[2]]}
                size={[0.42, 0.44, 0.42]}
                color="#6b4c28"
                roughness={0.7}
              />
  ...
  return (
    <group position={pos}>
      {Array.from({ length: steps }).map((_, i) => (
        <mesh
          key={i}
          position={[0, (i + 0.5) * stepH, (i + 0.5) * stepD]}
          castShadow
          receiveShadow
        >
      ...
      {/* Wooden Handrail */}
      <mesh
        position={[width * 0.48, height * 0.55, depth * 0.5]}
    ...
    case "armchair":
      ...
      return (
        <group>
          ...
          />
          <Box
            pos={[-w * 0.22, 0.52, 0.02]}
            size={[w * 0.4, 0.18, d * 0.65]}
            color="#9aaebb"
            roughness={0.85}
          />
          <Box
          ...
          {isL && (
            <Box
              pos={[w * 0.3, 0.32, d * 0.35]}
              size={[w * 0.4, 0.38, d * 0.5]}
              color={color}
              roughness={0.8}
            />
          )}
...
function Scene({ showRoof, timeOfDay, showAllFloors }) {
  ...
  const sunColor =
    timeOfDay > 0.6 ? "#fff8f0" : timeOfDay > 0.3 ? "#ffd090" : "#c08060";
